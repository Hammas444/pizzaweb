...
$update = "SELECT * from cart where cart_id='$cart_id'";
...
if(isset($_POST['save'])){
    ...
    $sql = "UPDATE cart SET customer_name='$customer_name',customer_email='$customer_email',customer_address='$customer_address',customer_phone='$customer_phone',payment_method='$payment_method',datee='$datee',quantity='$quantity',order_size='$order_size'  where cart_id='$cart_id'";
...
<div class="container">
  <div class="row">
   ...
   <img class="img" src="<?php echo $data['item_image']; ?>" alt="">
  </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12">
    <center><br><br>
<form style="font-family: 'Comfortaa', cursive;" action="" method="post" enctype="multipart/form-data">
<h1>Update Cart Details</h1>
 
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Name</label>
    <input style="width:100%;" type="text" class="form-control" id="exampleInputPassword1" name="customer_name" value="<?php echo $data['customer_name']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Email</label>
    <input style="width:100%;" type="email" class="form-control" id="exampleInputPassword1" name="customer_email" value="<?php echo $data['customer_email']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Address</label>
    <input style="width:100%;" type="text" class="form-control" id="exampleInputPassword1" name="customer_address" value="<?php echo $data['customer_address']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Phone</label>
    <input style="width:100%;" type="number" class="form-control" id="exampleInputPassword1" name="customer_phone" value="<?php echo $data['customer_phone']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Name</label>
    <input style="width:100%;" type="text" class="form-control" id="exampleInputPassword1" name="item_name" value="<?php echo $data['item_name']; ?>" disabled>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Id</label>
    <input style="width:100%;" type="number" class="form-control" id="exampleInputPassword1" name="item_id" value="<?php echo $data['item_id']; ?>"  disabled>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Price</label>
    <input style="width:100%;" type="number" class="form-control" id="exampleInputPassword1" name="item_price" value="<?php echo $data['item_price']; ?>" disabled>
  </div>
...
<option style="width:100%;" value="ONLINE PAYMENT">ONLINE PAYMENT</option>
  ...
  <div class="mb-3">
    ...
    <input style="width:100%;" type="date" class="form-control" id="exampleInputPassword1" name="datee" value="<?php echo $data['datee']; ?>" required>
  </div>
  <div class="mb-3">
...
<option style="width:100%;" value="Large">Large</option>
  ...
  <button type="submit" class="btn btn-" style="background-color: #ff5e62 ;border-radius: 0%;font-family: 'Comfortaa', cursive;letter-spacing: 2px;"  name="save"><a style="color:white;text-decoration:none;" >Update</a></button>
</form>
</center>
    </div>
  </div>
...
<h1>Update Cart Details</h1>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Name</label>
    <input style="width:50%;" type="text" class="form-control" id="exampleInputPassword1" name="customer_name" value="<?php echo $data['customer_name']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Email</label>
    <input style="width:50%;" type="email" class="form-control" id="exampleInputPassword1" name="customer_email" value="<?php echo $data['customer_email']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Address</label>
    <input style="width:50%;" type="text" class="form-control" id="exampleInputPassword1" name="customer_address" value="<?php echo $data['customer_address']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Phone</label>
    <input style="width:50%;" type="number" class="form-control" id="exampleInputPassword1" name="customer_phone" value="<?php echo $data['customer_phone']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Name</label>
    <input style="width:50%;" type="text" class="form-control" id="exampleInputPassword1" name="item_name" value="<?php echo $data['item_name']; ?>" disabled>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Id</label>
    <input style="width:50%;" type="number" class="form-control" id="exampleInputPassword1" name="item_id" value="<?php echo $data['item_id']; ?>"  disabled>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Price</label>
    <input style="width:50%;" type="number" class="form-control" id="exampleInputPassword1" name="item_price" value="<?php echo $data['item_price']; ?>" disabled>
  </div>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Payment Method</label>
<select style="width:50%;" class="form-select" name="payment_method" aria-label="Default select example">
  <option selected>Select payment method</option>
...
<option style="width:50%;" value="ONLINE PAYMENT">ONLINE PAYMENT</option>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Date</label>
    <input style="width:50%;" type="date" class="form-control" id="exampleInputPassword1" name="datee" value="<?php echo $data['datee']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Order Size</label>
<select style="width:50%;" class="form-select" name="order_size" aria-label="Default select example">
  <option selected>Select size</option>
...
<option style="width:50%;" value="Large">Large</option>
  ...
  <button type="submit" class="btn btn-" style="background-color: #ff5e62 ;border-radius: 0%;font-family: 'Poppins', sans-serif;letter-spacing: 2px;"  name="save"><a style="color:white;text-decoration:none;" >Update</a></button>
</form>
</center> -->
