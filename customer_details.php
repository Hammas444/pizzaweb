...
<table class="table table- table-hover" style="margin-top:5%;background:#FBD786;  font-family: 'Comfortaa', cursive;">
<thead>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td><?php echo $data['customer_password']; ?></td>
      <td><?php echo $data['customer_address']; ?></td>
      <td><?php echo $data['customer_phone']; ?></td>
      <td><a href="update_customer.php?customer_id=<?php echo $data['customer_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-edit" style="font-size:24px; color:green;"></i></a></td>
      <td><a href="delete_customer.php?customer_id=<?php echo $data['customer_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-close" style="font-size:24px; color:red;"></i></a></td>
    </tr>
  </tbody>
