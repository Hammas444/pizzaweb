...
$update = "SELECT * from customers where customer_id='$customer_id'";
...
<div class="container" style="font-family: 'Comfortaa', cursive;">
    <div class="row">
        ...
        <div class="col-sm-6" style="box-shadow:0 5px 5px gray ;">
          <h3 class="text-center" style="color:darkorange ;">Update Customer</h3>
          <br>
...
<br>
            ...
            <div class="mb-3">
              ...
              <input type="password"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="customer_password" value="<?php echo $data['customer_password']; ?>" required>
            </div>
<br>
...
<br>
      <div class="col-sm-6" style="background-color:#a8ff78;height:690px;width: 480px;box-shadow:0 5px 5px gray ;" >
...
<h1>Update Customer</h1>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Password</label>
    <input type="password" class="form-control" id="exampleInputPassword1" name="customer_password" value="<?php echo $data['customer_password']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Address</label>
