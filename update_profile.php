...
if(isset($_POST['save'])){
    ...
    if(isset($_POST['save'])){
        ...
        $sql = "UPDATE customers SET customer_name='$customer_name', customer_email='$customer_email', customer_password='$customer_password', customer_address='$customer_address', customer_phone='$customer_phone'   where customer_email='$email'";
...
<nav class="navbar navbar-expand-lg navbar- ">
      ...
      <br>
<!-- <div class="topnav" id="myTopnav" style="margin-left: 430px;font-family: 'Poppins', sans-serif;">
...
<center><h1 style="font-family: 'Poppins', sans-serif;">Update Profile</h1>
<form action="" method="post" style="font-family: 'Poppins', sans-serif;">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Email address</label>
    <input type="email" style="width:50% ;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?php echo $data['customer_email']; ?>" required>

  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Password</label>
    <input type="password" style="width:50% ;" class="form-control" id="exampleInputPassword1" name="password" value="<?php echo $data['customer_password']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Name</label>
    <input type="text" style="width:50% ;" class="form-control" id="exampleInputPassword1" name="name" value="<?php echo $data['customer_name']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Address</label>
    <input type="text" style="width:50% ;" class="form-control" id="exampleInputPassword1" name="Address" value="<?php echo $data['customer_address']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Phone</label>
    <input type="number" style="width:50% ;" class="form-control" id="exampleInputPassword1" name="Phone" value="<?php echo $data['customer_phone']; ?>" required>
  </div>
...
<form action="" method="post">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Email address</label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?php echo $data['customer_email']; ?>" required>
    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Password</label>
    <input type="password" class="form-control" id="exampleInputPassword1" name="password" value="<?php echo $data['customer_password']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Name</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="name" value="<?php echo $data['customer_name']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Address</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="Address" value="<?php echo $data['customer_address']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Phone</label>
    <input type="number" class="form-control" id="exampleInputPassword1" name="Phone" value="<?php echo $data['customer_phone']; ?>" required>
  </div>
