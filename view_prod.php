...
<div class="container" style="font-family: 'Comfortaa', cursive;"><center><h1 style="   font-family: 'Kaushan Script', cursive;font-weight:600;color:#e53935">Item Details</h1></center>
<div class="row" >
<?php
...
?>
    <div class="col-sm-12 col-md-4 col-lg-4" id="line" style=""><br>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4" id="line" style=""><br><br>
        <div class="container-fluid">
            <b><h1 class="card-title" style="font-family: 'Kalam', cursive;color:#00b09b;
                ;font-weight: 600;font-size:42px;"><?php echo $data['item_name']; ?></h1></b>
                 <h3 style="color:rgb(44, 3, 37) ;"><b>Item Id :</b> <?php echo $data['item_id']; ?><br></h3><br>
                 <h3 style="color:rgb(44, 3, 37);font-weight: 700;" class="card-text">Price:<?php echo $data['item_price']; ?></h3>
                 <form>
...
<form>
               ...
               <br>
               <button type="submit" class="btn btn-" style="background-color:#45B649;border-radius: 0%;font-family: 'Comfortaa', cursive;letter-spacing: 2px;"  name="save"><a style="color:white;text-decoration:none;" href="update_prod.php?item_id=<?php echo $data['item_id']; ?>&email=<?php echo $_GET['email'] ?>">Update Item</a></button><br><br>
               <button type="submit" class="btn btn-" style="background-color:#ADA996;border-radius: 0%;font-family: 'Comfortaa', cursive;letter-spacing: 2px;"  name="save"><a style="color:white;text-decoration:none;" href="delete_prod.php?item_id=<?php echo $data['item_id']; ?>&email=<?php echo $_GET['email'] ?>">Delete Item</a></button><br><br>
...
<thead>
  ...
  <tbody> -->
    ...
    <!-- <tr>
      ...
      <td><img class="product" src="<?php echo $data['item_image']; ?>" ></td>
      <td><?php echo $data['item_price']; ?></td>
      <td><a href="update_prod.php?item_id=<?php echo $data['item_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-edit" style="font-size:24px; color:green;"></i></a></td>
      <td><a href="delete_prod.php?item_id=<?php echo $data['item_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-close" style="font-size:24px; color:red;"></i></a></td>
    </tr>
  </tbody> -->
