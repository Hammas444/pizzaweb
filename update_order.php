...
$update = "SELECT * from orders where order_id='$order_id'";
...
if(isset($_POST['save'])){
    ...
    $sql = "UPDATE orders SET customer_name='$customer_name',customer_email='$customer_email',customer_address='$customer_address',customer_phone='$customer_phone',item_name='$item_name',item_id='$item_id',item_price='$item_price',item_image='$item_image',payment_method='$payment_method',datee='$datee',quantity='$quantity',item_image='$destfile',order_size='$order_size'  where order_id='$order_id'";
...
<div class="container" style="font-family: 'Comfortaa', cursive;">
    <div class="row">
        ...
        <div class="col-sm-6" style="box-shadow:0 5px 5px gray ;">
          <h3 class="text-center" style="color:darkorange ;">Update Order</h3>
          <br>
          <form action="" method="post" enctype="multipart/form-data">

          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Customer Name</label>
              <input type="text"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="customer_name" value="<?php echo $data['customer_name']; ?>" required>
...
<br>
            ...
            <div class="mb-3">
              ...
              <input type="email"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="customer_email" value="<?php echo $data['customer_email']; ?>" required>
     
            </div>
            <br>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Customer Address</label>
              <input type="text"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="customer_address" value="<?php echo $data['customer_address']; ?>" required>
            </div>
<br>
  
<div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Customer Phone</label>
              <input type="number"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="customer_phone" value="<?php echo $data['customer_phone']; ?>" required>
            </div>
<br>
<div class="mb-3">
...
<div class="mb-3">
              ...
              <input type="number"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="item_id" value="<?php echo $data['item_id']; ?>"  disabled>
            </div>
            <br>
            <div class="mb-3">
...
<div class="mb-3">
              ...
              <input type="text"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="payment_method" value="<?php echo $data['payment_method']; ?>" required>
            </div>
            <br>
<div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Date</label>
              <input type="date"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="datee" value="<?php echo $data['datee']; ?>" required>
            </div>
            <br>
<div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Quantity</label>
              <input type="number"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="quantity" value="<?php echo $data['quantity']; ?>" required>
            </div>
            <br>
<div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Order Size</label>
              <input type="text"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="order_size" value="<?php echo $data['order_size']; ?>" required>
            </div>
...
<br>
      <div class="col-sm-6" style="background-color:#FBD786;height:1420px;width: 480px;box-shadow:0 5px 5px gray ;" >
...
<h1>Update Order</h1>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="customer_name" value="<?php echo $data['customer_name']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Email</label>
    <input type="email" class="form-control" id="exampleInputPassword1" name="customer_email" value="<?php echo $data['customer_email']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Address</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="customer_address" value="<?php echo $data['customer_address']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Customer Phone</label>
    <input type="number" class="form-control" id="exampleInputPassword1" name="customer_phone" value="<?php echo $data['customer_phone']; ?>" required>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" id="exampleInputPassword1" name="item_id" value="<?php echo $data['item_id']; ?>"  disabled>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product image Old</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="item_imageold" value="<?php echo $data['item_image']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">New Product image</label>
    <input type="file" class="form-control" id="exampleInputPassword1" name="item_image" value="<?php echo $data['item_image']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Payment Method</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="payment_method" value="<?php echo $data['payment_method']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Date</label>
    <input type="date" class="form-control" id="exampleInputPassword1" name="datee" value="<?php echo $data['datee']; ?>" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Quantity</label>
    <input type="number" class="form-control" id="exampleInputPassword1" name="quantity" value="<?php echo $data['quantity']; ?>" required>
  </div>
