...
<table class="table table- table-hover" style="margin-top:5%;  font-family: 'Comfortaa', cursive;">
<thead>
    <tr>
...
?>
    ...
    <td><?php echo $data['order_size']; ?></td>
      <td><a href="update_order.php?order_id=<?php echo $data['order_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-edit" style="font-size:24px; color:green;"></i></a></td>
      <td><a href="delete_order.php?order_id=<?php echo $data['order_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class="fa fa-close" style="font-size:24px; color:red;"></i></a></td>
    </tr>
  </tbody>
