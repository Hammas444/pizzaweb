...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="uploads/admin.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption  d-md-block" style="margin-bottom:40px ;">
          <h1 style="font-family: 'Poppins', sans-serif;font-weight:700 ;font-size:50px ;color:#4286f4;" >Admin Portal</h1>
          <p >check every new update</p>
          <a class="btn btn- " href="order_details.php?email=<?php echo $_GET['email']; ?>" role="button"   id="mainbutton">Check Orders</a>
        </div>
      </div>
...
<div class="card mt-2" style="width: 18rem;">
  <img src="<?php echo $data['item_image']; ?>" class="card-img-top" alt="..." style="height:250px;">
  <div class="card-body">
    <h5 class="card-title"><?php echo $data['item_name']; ?></h5>
    <p class="card-text"><?php echo $data['item_price']; ?></p>
