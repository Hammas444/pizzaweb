...
<div class="container" style="font-family: 'Comfortaa', cursive;">
    <div class="row">
        ...
        <div class="col-sm-6" style="box-shadow:0 5px 5px gray ;">
          <h3 class="text-center" style="color:darkorange ;">Create Admin</h3>
          <br>
          <form action="admin_process.php?email=<?php echo $_GET['email']; ?>" method="post" enctype="multipart/form-data">

            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Admin Name</label>
              <input type="text"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="admin_name" required>
...
<br>
            ...
            <div class="mb-3">
              ...
              <input type="email"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="admin_email" required>
            ...
            <div class="mb-3">
              ...
              <input type="password"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="admin_password" required>
            </div>
<br>
...
<button type="submit" class="btn btn-" style="background-color: lightseagreen ;border-radius: 0%;font-family: 'Comfortaa', cursive;letter-spacing: 2px;color:white;"  name="save">Create</button>
          </form>
      </div>
<br>
      <div class="col-sm-6" style="background-color:#9796f0;height:500px;width: 480px;box-shadow:0 5px 5px gray ;" >
...
<h1>Create Admin</h1>
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control" id="exampleInputPassword1" name="admin_email" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Admin Password</label>
