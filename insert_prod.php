...
<div class="container" style="font-family: 'Comfortaa', cursive;">
    <div class="row">
        ...
        <div class="col-sm-6" style="box-shadow:0 5px 5px gray ;">
          <h3 class="text-center" style="color:darkorange ;">Insert Item</h3>
          <br>
          <form action="prod_process.php?email=<?php echo $_GET['email']; ?>" method="post" enctype="multipart/form-data">

            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Item Name</label>
              <input type="text"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="item_name" required>
...
<br>
            ...
            <div class="mb-3">
              ...
              <input type="number"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="item_price" required>
            ...
            <div class="mb-3">
              ...
              <input type="file"  style="border-radius:0% ;border-top: none;border-left: none;border-right: none;" class="form-control" id="exampleInputPassword1" name="item_image" required>
            </div>
<br>
...
<button type="submit" class="btn btn-" style="background-color: lightseagreen ;border-radius: 0%;font-family: 'Comfortaa', cursive;letter-spacing: 2px;color:white;"  name="save">Insert</button>
          </form>
      </div>
<br>
      <div class="col-sm-6" style="background-color:#FBD786;height:500px;width: 480px;box-shadow:0 5px 5px gray ;" >
...
<h1>Insert Product</h1>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="item_name" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Price</label>
    <input type="number" class="form-control" id="exampleInputPassword1" name="item_price" required>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Product Image</label>
    <input type="file" class="form-control" id="exampleInputPassword1" name="item_image" required>
  </div>
